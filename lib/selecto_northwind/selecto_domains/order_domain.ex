defmodule SelectoNorthwind.SelectoDomains.OrderDomain do
  ...
  def base_domain do
    %{
      # Generated from: SelectoNorthwind.Sales.Order
      ...
      schemas: %{
        :customer => %{
          # Expanded schema configuration for customers
        ...
        :employee => %{
          # Expanded schema configuration for employees
        ...
        :shipper => %{
          # Expanded schema configuration for shippers
          source_table: "shippers",
          primary_key: :id,
          fields: [:id, :company_name, :phone, :inserted_at, :updated_at],
          redact_fields: [],
          columns: %{
            :company_name => %{type: :string},
            :id => %{type: :integer},
      ...
      joins: %{
        :customer => %{
          ...
          filters: %{"country" => %{name: "Country", type: :string}},
          fields: %{company_name: %{type: :string}, country: %{type: :string}}
        },
        :employee => %{
          name: "Employee",
          type: :inner,
