defmodule SelectoNorthwind.SelectoDomains.Overlays.EmployeeDomainOverlay do
  ...
  # defcolumn :related_id do
  #   choice_source :related_choices
  #   reference %{
  #     choice_source: :related_choices,
  #     value_source: "related.id",
  #     caption_source: "related.name"
  #   }
  # end

  # defsource_relationship(:related, %{
  #   target_domain: :relateds,
  #   source_field: :related_id,
  #   target_field: :id,
  #   source_path: "related"
  # })

  # defchoice_source(:related_choices, %{
  #   domain: :relateds,
  #   value_field: :id,
  #   label_field: :name,
  #   source_relationship: :related,
  #   constraint_policy: %{domain_of_interest: :fail_closed},
  #   presentation: %{control: :autocomplete, mode: :async, cardinality: :one}
  # })
