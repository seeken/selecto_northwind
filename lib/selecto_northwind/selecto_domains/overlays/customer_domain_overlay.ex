defmodule SelectoNorthwind.SelectoDomains.Overlays.CustomerDomainOverlay do
  @moduledoc """
  Overlay configuration for SelectoNorthwind.SelectoDomains.CustomerDomain.
  ...
  # defcolumn :address do
  #   label "Address"
  #   max_length 100
  # end

  # defcolumn :updated_at do
  #   label "Updated At"
  #   max_length 100
  # end
  ...
  # deffilter "address_search" do
  #   name "Search Address"
  #   type :string
  #   description "Filter by address containing text"
  # end
  ...
  # defcolumn :customer_id do
  #   choice_source :customer_choices
  #   reference %{
  #     choice_source: :customer_choices,
  #     value_source: "customer.id",
  #     caption_source: "customer.name"
  #   }
  # end
