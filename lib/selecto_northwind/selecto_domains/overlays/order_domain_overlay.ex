defmodule SelectoNorthwind.SelectoDomains.Overlays.OrderDomainOverlay do
  @moduledoc """
  Overlay configuration for SelectoNorthwind.SelectoDomains.OrderDomain.
