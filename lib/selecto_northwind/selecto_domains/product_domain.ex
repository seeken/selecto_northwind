defmodule SelectoNorthwind.SelectoDomains.ProductDomain do
  ...
  use SelectoNorthwind.SavedViewConfigContext
  ...
  def base_domain do
    %{
      ...
      schemas: %{
        :category => %{
          # Expanded schema configuration for categories
          ...
          redact_fields: [],
          columns: %{
            # star mode: displays category_name, filters by ID
            :category_name => %{
              type: :string,
              id_field: :id,
        ...
        :flag_type => %{
          # Placeholder for SelectoNorthwind.Support.FlagType; run
          # mix selecto.gen.domain SelectoNorthwind.Support.FlagType
          # or add --expand-schemas flag_type to expand this schema automatically
        ...
        :order_detail => %{
          # Expanded schema configuration for order_details
        ...
        :product_flag => %{
          # Placeholder for SelectoNorthwind.Support.ProductFlag; run
          # mix selecto.gen.domain SelectoNorthwind.Support.ProductFlag
          # or add --expand-schemas product_flag to expand this schema automatically
        ...
        :supplier => %{
          # Expanded schema configuration for suppliers
          # Join mode: star (lookup table with ID-based filtering)
          ...
          columns: %{
            :address => %{type: :string},
            :city => %{type: :string},
            # star mode: displays company_name, filters by ID
            :company_name => %{
              type: :string,
              id_field: :id,
        ...
        :tag => %{
          # Expanded schema configuration for tags
          ...
          columns: %{
            ...
            :id => %{hidden: true, type: :integer},
            :inserted_at => %{type: :naive_datetime},
            # tag mode: displays name, filters by tag ID
            :name => %{
              type: :string,
              id_field: :id,
              display_field: :name,
