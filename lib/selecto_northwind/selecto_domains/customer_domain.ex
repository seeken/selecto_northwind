defmodule SelectoNorthwind.SelectoDomains.CustomerDomain do
  ...
  def base_domain do
    %{
      # Generated from: SelectoNorthwind.Sales.Customer
      ...
      schemas: %{
        :customer_demographic => %{
          # Expanded schema configuration for customer_demographics
          source_table: "customer_demographics",
          primary_key: :customer_type_id,
          fields: [:customer_type_id, :customer_desc, :inserted_at, :updated_at],
          redact_fields: [],
          columns: %{
      ...
      joins: %{
        :customer_types => %{
          ...
          join_table: "customer_customer_demo",
          join_through: "customer_customer_demo",
          join_keys: [customer_id: :customer_id, customer_type_id: :customer_type_id],
          main_foreign_key: "customer_id",
          tag_foreign_key: "customer_type_id",
          owner_key: :customer_id,
          assoc_key: :id
        },
        :orders => %{
