defmodule SelectoNorthwind.SavedViewConfigContext do
  @moduledoc """
  ...
  defmacro __using__(_opts \\ []) do
    quote do
      ...
      def get_view_config(name, context, view_type, opts \\ []) do
        ...
        query =
          from v in SelectoNorthwind.SavedViewConfig,
            where: v.name == ^name,
        ...
        SelectoNorthwind.Repo.one(query)
      end
      ...
      def save_view_config(name, context, view_type, params, opts \\ []) do
        ...
        case get_view_config(name, context, view_type, user_id: user_id) do
          nil ->
            %SelectoNorthwind.SavedViewConfig{}
            |> SelectoNorthwind.SavedViewConfig.changeset(%{
              name: name,
              context: context,
              view_type: view_type,
              params: params,
      ...
      def list_view_configs(context, view_type, opts \\ []) do
        ...
        SelectoNorthwind.Repo.all(query)
      end
        ...
        case get_view_config(name, context, view_type, user_id: user_id) do
          ...
          config ->
            if config.user_id == user_id do
              SelectoNorthwind.Repo.delete(config)
            else
              {:error, :unauthorized}
            end
        end
