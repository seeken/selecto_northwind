defmodule SelectoNorthwindWeb.CustomerLive do
  @moduledoc """
  LiveView for Customer using SelectoComponents.
  ...
  def mount(_params, _session, socket) do
    ...
    saved_views = SelectoNorthwind.SelectoDomains.CustomerDomain.get_view_names(path)
    ...
    socket =
      assign(socket,
        ...
        views: views,
        my_path: path,
        saved_view_module: SelectoNorthwind.SelectoDomains.CustomerDomain,
  ...
  def render(assigns) do
    ...
    <div class="container mx-auto px-4 py-8">
      <h1 class="text-3xl font-bold mb-6">Customer Explorer</h1>
